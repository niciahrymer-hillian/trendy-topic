...
export default function Wow() {
  ...
  const cloud: EChartsOption = {
    ...
    series: [{
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      label: { show: true, formatter: (p: any) => p.data.name, color: "#e6edf3" },
  ...
  return (
    <div>
      ...
      <Section id="heat" title="Global Question Heatmap — topic intensity by country">
        <EChart option={heatmapOption(heat.data as unknown as Record<string, string | number>[], "country", "topic_label", "conversations")} height={460} />
      </Section>
